...
(function($) {
  ...
  function SCSAjaxChosen(element, options) {
    this.element = $(element);
    this.options = options;
    this.init();
  };

  SCSAjaxChosen.prototype.init = function() {
  ...
  SCSAjaxChosen.prototype.events = function() {
  ...
  SCSAjaxChosen.prototype.search_field_focused = function() {
  ...
  SCSAjaxChosen.prototype.search_welcome_message = function() {
  ...
  SCSAjaxChosen.prototype.update_list = function() {
    ...
    this.timer = setTimeout( function() {
      ...
      _this.chosenXhr = window.wp.ajax.post('scs-chosen', _this.options.data).done( function( response ) {
  ...
  SCSAjaxChosen.prototype.show_results = function( items ) {
    ...
    if( this.is_multiple ) {
      ...
      var $hidden_select = this.element.parent().find('.scs-hide-select');
      var $hidden_value  = $hidden_select.val() || [];

      this.element.SCSChosenOrder($hidden_value, true);
  ...
  $.fn.SCSAjaxChosen = function(chosenOptions) {
    return this.each(function() {
      new SCSAjaxChosen(this, chosenOptions);
    });
  };
...
(function() {
  var $, SCSAbstractChosenOrder, _ref,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; },
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };

  SCSAbstractChosenOrder = (function() {

    function SCSAbstractChosenOrder() {}

    SCSAbstractChosenOrder.insertAt = function(node, index, parentNode) {
      return parentNode.insertBefore(node, parentNode.children[index].nextSibling);
    };

    SCSAbstractChosenOrder.getFlattenedOptionsAndGroups = function(select) {
    ...
    SCSAbstractChosenOrder.isValidMultipleSelectElement = function(element) {
      return element !== null && typeof element !== "undefined" && element.nodeName === "SELECT" && element.multiple;
    };

    SCSAbstractChosenOrder.getChosenUIContainer = function(select) {
      if (select.id !== "") {
    ...
    SCSAbstractChosenOrder.isChosenified = function(select) {
      return this.getChosenUIContainer(select) != null;
    };

    SCSAbstractChosenOrder.forceSelection = function(select, selection) {
    ...
    SCSAbstractChosenOrder.SCSChosenOrder = function(select, order, force) {
  ...
  $.fn.extend({
    SCSChosenOrder: function(order, force) {
      return _SCSChosenOrder.SCSChosenOrder(this, order, force);
    }
  });

  this._SCSChosenOrder = (function(_super) {
    __extends(_SCSChosenOrder, _super);

    function _SCSChosenOrder() {
      _ref = _SCSChosenOrder.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    _SCSChosenOrder.relAttributeName = 'data-option-array-index';

    _SCSChosenOrder.isjQueryObject = function(obj) {
      return (typeof jQuery !== "undefined" && jQuery !== null) && obj instanceof jQuery;
    };

    _SCSChosenOrder.getDOMElement = function(element) {
    ...
    _SCSChosenOrder.searchChosenUIContainer = function(element) {
    ...
    _SCSChosenOrder.triggerEvent = function(target, event_name) {
      return $(target).trigger(event_name);
    };

    return _SCSChosenOrder;

  })(SCSAbstractChosenOrder);
    ...
    applyRule: function(context, enforced) {
      ...
      if( result ) {
        ...
        $(controls).each(function() {
          $(this).removeClass('scs-depend-on');
        });
...
(function(root, factory) {
  ...
  if (typeof $.fn !== "undefined") {
    $.fn.serializeObjectSCS = FormSerializer.serializeObject;
    $.fn.serializeJSONSCS   = FormSerializer.serializeJSON;
  }
