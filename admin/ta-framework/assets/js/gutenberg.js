...
( function( blocks, blockEditor, element, components ) {
  ...
  if ( !window.scs_gutenberg_blocks ) { return; }

  Object.values(window.scs_gutenberg_blocks).forEach( function( block ) {
    ...
    registerBlockType(block.name, {
      ...
      edit: function (props) {
        return (
          createElement('div', {className: 'scs-shortcode-block'},

            createElement(Button, {
              'data-modal-id': block.modal_id,
              'data-gutenberg-id': block.name,
              className: 'is-secondary scs-shortcode-button',
              onClick: function () {
                window.scs_gutenberg_props = props;
              },
            }, block.button_title ),
