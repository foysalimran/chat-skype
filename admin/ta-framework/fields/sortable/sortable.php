	...
	class SCS_Field_Sortable extends SCS_Fields {
		...
		public function render() {
			...
			foreach ( $pre_sortby as $key => $field ) {
				...
				echo '<div class="scs-sortable-item">';

				echo '<div class="scs-sortable-content">';
				...
				SCS::field( $field, $field_value, $unique_id, 'field/sortable' );

				echo '</div>';

				echo '<div class="scs-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
