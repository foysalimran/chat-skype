 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'SCS_Field_color' ) ) {
	class SCS_Field_color extends SCS_Fields {
		...
		public function render() {
			...
			echo '<input type="text" name="' . esc_attr( $this->field_name() ) . '" value="' . esc_attr( $this->value ) . '" class="scs-color"' . wp_kses_post( $default_attr ) . wp_kses_post( $this->field_attributes() ) . '/>';
