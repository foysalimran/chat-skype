...
if ( ! class_exists( 'SCS_Field_wp_editor' ) ) {
	class SCS_Field_wp_editor extends SCS_Fields {
		...
		public function render() {
			...
			echo ( scs_wp_editor_api() ) ? '<div class="scs-wp-editor" data-editor-settings="' . esc_attr( json_encode( $editor_settings ) ) . '">' : '';
		...
		public function setup_wp_editor_media_buttons() {
			...
			echo 'var scs_media_buttons = ' . json_encode( $media_buttons ) . ';';
			echo '</script>';
		}
