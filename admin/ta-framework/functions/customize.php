 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Panel_SCS' ) && class_exists( 'WP_Customize_Panel' ) ) {
	class WP_Customize_Panel_SCS extends WP_Customize_Panel {
		public $type = 'scs';
	}
}
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Section_SCS' ) && class_exists( 'WP_Customize_Section' ) ) {
	class WP_Customize_Section_SCS extends WP_Customize_Section {
		public $type = 'scs';
	}
}
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Control_SCS' ) && class_exists( 'WP_Customize_Control' ) ) {
	class WP_Customize_Control_SCS extends WP_Customize_Control {
		...
		public function render() {
			...
			if ( ! empty( $this->field['dependency'] ) ) {
				...
				$visible  = ' scs-dependency-control';
		...
		public function render_field_content() {
			...
			$class      = ( $is_complex || $custom ) ? ' scs-customize-complex' : '';
			...
			echo '<div class="scs-customize-field' . esc_attr( $class ) . '"' . wp_kses_post( $atts ) . '>';
