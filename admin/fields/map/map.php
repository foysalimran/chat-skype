  ...
  class SCS_Field_map extends SCS_Fields {
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'scs-leaflet' ) ) {
        wp_enqueue_script( 'scs-leaflet', SCS_DIR_URL .'admin/assets/js/leaflet.js' , array( 'chat-skype' ), $this->version, true );
      }

      if ( ! wp_style_is( 'scs-leaflet' ) ) {
        wp_enqueue_style( 'scs-leaflet', SCS_DIR_URL . $this->version .'admin/assets/css/leaflet.css' , array(), $this->version );
      }
