  ...
  class SCS_Field_media extends SCS_Fields {
    ...
    public function render() {
      ...
      if ( ! empty( $args['preview'] ) ) {
        ...
        echo '<div class="scs-image-preview"'. $preview_style .'>';
      ...
      echo ( empty( $args['preview'] ) ) ? '<a href="#" class="button button-secondary scs-warning-primary scs--remove'. esc_attr( $hidden_auto ) .'">'. $args['remove_title'] .'</a>' : '';
      echo '</div>';
