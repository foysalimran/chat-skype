	...
	class SCS_Setup {
		...
		public static function add_admin_enqueue_scripts() {
			...
			if ( apply_filters( 'scs_fa4', false ) ) {
				wp_enqueue_style( 'scs-fa4', SCS_DIR_URL . 'admin/assets/css/font-awesome.min.css', array(), '4.7.0', 'all' );
			} else {
				wp_enqueue_style( 'scs-fa5', SCS_DIR_URL . 'admin/assets/css/fontawesome-free@5.15.4_css_all.min.css', array(), '5.15.5', 'all' );
				wp_enqueue_style( 'scs-fa5-v4-shims', SCS_DIR_URL . 'admin/assets/css/fontawesome-free@5.15.4_css_v4-shims.min.css', array(), '5.15.5', 'all' );
			}
			...
			wp_enqueue_script( 'chat-skype', self::include_plugin_url( 'assets/js/main' . $min . '.js' ), array( 'scs-plugins' ), self::$version, true );
		...
		public static function field( $field = array(), $value = '', $unique = '', $where = '', $parent = '' ) {
			...
			echo wp_kses_post( '<div class="scs-field scs-field-' . esc_attr( $field_type ) . esc_attr( $is_pseudo ) . esc_attr( $class ) . esc_attr( $visible ) . '"' . wp_kses_data( $depend ) . '>' );
