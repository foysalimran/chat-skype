...
SCS::createSection($prefix, array(
  'title'  => esc_html__('SCS settings', 'chat-skype'),
  'icon'   => 'fab fa-skype',
  'fields' => array(
    ...
    array(
      'id'    => 'select-timezone',
      'type'  => 'select',
      'title' => esc_html__('Timezone', 'chat-skype'),
      'subtitle' => esc_html__('When using the date and time from the user browser you can transform it to your current timezone (in case your user is in a different timezone)', 'chat-skype'),
      'chosen'      => true,
      'placeholder' => esc_html__('Select timezone', 'chat-skype'),
      'options' => $timezones,
    ),
    ...
    array(
      'id'    => 'opt-availablity',
      'type'  => 'tabbed',
      'title' => esc_html__('Availablity', 'chat-skype'),
      'subtitle' => esc_html__('24-hour Time without PM:AM" eg: From 00:00 to 23:59. If you are offline for any specefic full day use 00:00 and 00:00 in From and To value.', 'chat-skype'),

      // sunday
      'tabs'  => array(
        array(
          'title'  => esc_html__('Sunday', 'chat-skype'),
          'fields' => array(
            array(
        ...
        // monday
        array(
          'title'  => esc_html__('Monday', 'chat-skype'),
          'fields' => array(
            array(
        ...
        // tuesday
        array(
          'title'  => esc_html__('Tuesday', 'chat-skype'),
          'fields' => array(
            array(
        ...
        // wednesday
        array(
          'title'  => esc_html__('Wednesday', 'chat-skype'),
          'fields' => array(
            array(
        ...
        // thursday
        array(
          'title'  => esc_html__('Thursday', 'chat-skype'),
          'fields' => array(
            array(
        ...
        // friday
        array(
          'title'  => esc_html__('Friday', 'chat-skype'),
          'fields' => array(
            array(
        ...
        // thursday
        array(
          'title'  => esc_html__('Saturday', 'chat-skype'),
          'fields' => array(
            array(
    ...
    array(
      'id'    => 'agent-photo',
      'type'    => 'media',
      'title'   => esc_html__('Agent photo', 'chat-skype'),
      'subtitle' => esc_html__('Add agent photo to show in the bubble.', 'chat-skype'),
      'library' => 'image',
      'placeholder' => SCS_DIR_URL . 'assets/image/user.webp',
      'preview' => true,
      'default' => [
    ...
    array(
      'id'    => 'agent-name',
      'type'    => 'text',
      'title'   => esc_html__('Agent name', 'chat-skype'),
      'subtitle' => esc_html__('Add your/agent name for shoing in bubble.', 'chat-skype'),
      'default' => esc_html__('John Doe', 'chat-skype'),
    ...
    array(
      'id'    => 'agent-subtitle',
      'type'    => 'text',
      'title'   => esc_html__('Subtitle', 'chat-skype'),
      'subtitle' => esc_html__('Add subtitle to show under agent name', 'chat-skype'),
      'default' => esc_html__('Typically replies within a day', 'chat-skype'),
    ...
    array(
      'id'    => 'agent-message',
      'type'    => 'textarea',
      'title'   => esc_html__('Message from agent', 'chat-skype'),
      'subtitle' => esc_html__('Add add custom message for shoing in message box.', 'chat-skype'),
      'default' => esc_html__('Hello, Welcome to the site. Please click below button for chatting me through Skype.', 'chat-skype'),
    ...
    array(
      'id'    => 'before-chat-icon',
      'type'  => 'icon',
      'title' => esc_html__('Icon for message button', 'chat-skype'),
      'default' => 'fab fa-skype',
      'subtitle' => esc_html__('Change icon for adding before send message text.', 'chat-skype'),
    ...
    array(
      'id'    => 'chat-button-text',
      'type'    => 'text',
      'title'   => esc_html__('Message button text', 'chat-skype'),
      'subtitle' => esc_html__('Add messasge button text', 'chat-skype'),
      'default' => esc_html__('Send a message', 'chat-skype'),
    ...
    array(
      'id'    => 'autoshow-popup',
      'type'    => 'switcher',
      'title'   => esc_html__('Auto open popup', 'chat-skype'),
      'subtitle' => esc_html__('Turn ON for open popup automatically.', 'chat-skype'),
      'default' => false,
    ),
    ...
    array(
      'id'      => 'bubble-position',
      'type'    => 'button_set',
      'title'   => esc_html__('Bubble position', 'chat-skype'),
      'default' => 'right',
      'options'    => array(
    ...
    array(
      ...
      'type'    => 'button_set',
      'title'   => esc_html__('Bubble visibility', 'chat-skype'),
      'default' => 'everywhere',
      'options'    => array(
        'everywhere'  => esc_html__('Everywhere', 'chat-skype'),
        'desktop' => esc_html__('Desktop Only', 'chat-skype'),
        'tablet' => esc_html__('Tablet Only', 'chat-skype'),
        'mobile' => esc_html__('Mobile Only', 'chat-skype'),
      ),
    ),
    ...
    array(
      'id'      => 'bubble-style',
      'type'    => 'button_set',
      'title'   => esc_html__('Select bubble layout mode', 'chat-skype'),
      'default' => 'default',
      'options'    => array(
        'default'  => esc_html__('Light mode', 'chat-skype'),
        'dark' => esc_html__('Dark mode', 'chat-skype'),
        'night' => esc_html__('Night mode', 'chat-skype'),
      ),
    ),
    ...
    array(
      ...
      'type'    => 'button_set',
      'title'   => esc_html__('Bubble header contnet position', 'chat-skype'),
      'default' => 'center',
      'options'    => array(
        'left'  => esc_html__('Left', 'chat-skype'),
    ...
    array(
      'id'    => 'select-animation',
      'type'  => 'select',
      'title' => esc_html__('Select animation for bubble', 'chat-skype'),
      'options' => array(
        '1'     => esc_html__('Fade Right', 'chat-skype'),
        '2'     => esc_html__('Fade Down', 'chat-skype'),
        '4'     => esc_html__('Fade In Scale', 'chat-skype'),
        '5'     => esc_html__('Rotation', 'chat-skype'),
        '6'     => esc_html__('Slide Fall', 'chat-skype'),
        '7'     => esc_html__('Slide Down', 'chat-skype'),
        '3'     => esc_html__('Ease Down', 'chat-skype'),
        '8'     => esc_html__('Rotate Left', 'chat-skype'),
        '9'     => esc_html__('Flip Horizontal', 'chat-skype'),
        '10'    => esc_html__('Flip Vertical', 'chat-skype'),
        '11'    => esc_html__('Flip Up', 'chat-skype'),
        '12'    => esc_html__('Super Scaled', 'chat-skype'),
        '13'    => esc_html__('Slide Up', 'chat-skype'),
        'random' => esc_html__('Random', 'chat-skype'),
      ),
      'default'     => 'random',
    ),
    ...
    array(
      'id'      => 'opt-button-style',
      'type'    => 'image_select',
      'title'   => esc_html__('Bubble button style', 'chat-skype'),
      'options' => array(
        '1' => SCS_DIR_URL . 'assets/image/bubble-1.png',
        '2' => SCS_DIR_URL . 'assets/image/bubble-2.png',
        '3' => SCS_DIR_URL . 'assets/image/bubble-3.png',
        '4' => SCS_DIR_URL . 'assets/image/bubble-4.png',
        '5' => SCS_DIR_URL . 'assets/image/bubble-5.png',
        '6' => SCS_DIR_URL . 'assets/image/bubble-6.png',
        '7' => SCS_DIR_URL . 'assets/image/bubble-7.png',
        '8' => SCS_DIR_URL . 'assets/image/bubble-8.png',
        '9' => SCS_DIR_URL . 'assets/image/bubble-9.png',
      ),
      'default' => '1',
    ),
    ...
    array(
      ...
      'type'  => 'icon',
      'title' => esc_html__('Icon for circle button', 'chat-skype'),
      'default' => 'fab fa-skype',
      'subtitle' => esc_html__('Change icon for circle button.', 'chat-skype'),
    ),
    ...
    array(
      'id'    => 'circle-animation',
      'type'  => 'select',
      'title' => esc_html__('Select animation for circle icon', 'chat-skype'),
      'options' => array(
        '1'     => esc_html__('Slide down', 'chat-skype'),
        '2'     => esc_html__('Rotate', 'chat-skype'),
        '3'     => esc_html__('Fade', 'chat-skype'),
        '4'     => esc_html__('Slide Up', 'chat-skype'),
      ),
      'default'     => '1',
    ),
    ...
    array(
      'id'    => 'bubble-text',
      'type'    => 'text',
      'title'   => esc_html__('Bubble text', 'chat-skype'),
      'subtitle' => esc_html__('Change text to show in bubble', 'chat-skype'),
      'default' => esc_html__('How may I help you?', 'chat-skype'),
...
SCS::createSection($prefix, array(
  ...
  'fields'      => array(
    ...
    array(
      ...
      'type'    => 'image_select',
      'title'   => esc_html__('Select button style', 'chat-skype'),
      'options' => array(
        '1' => SCS_DIR_URL . 'assets/image/button-with-info.png',
        '2' => SCS_DIR_URL . 'assets/image/button2.png',
      ),
      'default' => '1',
    ),
    ...
    array(
      'type'    => 'content',
      'content' => '[scs style="1" skypeid="myskypeid1222" timezone="Asia/Dhaka" photo="/wp-content/uploads/2022/11/user.webp" name="Jhon" designation="Techinical support" label="How can I help you?" online="I am on" offline="I am off" visibility="skySupport-show-everywhere" sizes="skySupport-btn-lg" sunday="00:00-23:59" monday="23:00-23:59" tuesday="00:00-23:59" wednesday="00:00-23:59" thursday="00:00-23:59" friday="00:00-23:59" saturday="00:00-23:59"]',
      'title' => esc_html__('Copy this shortcode and paste it in any pages/posts/widget. Edit values as you need.', 'chat-skype'),
      'dependency' => array('opt-shortcode-select', 'any', '1'),
    ),

    array(
      'type'    => 'content',
      'content' => '[scs style="2" skypeid="myskypeid1222" label="How can I help you?" visibility="skySupport-show-everywhere" sizes="skySupport-btn-lg"]',
      'title' => esc_html__('Copy this shortcode and paste it in any pages/posts/widget. Edit values as you need.', 'chat-skype'),
...
//
SCS::createSection($prefix, array(
  'title'       => esc_html__('Backup', 'chat-skype'),
  'icon'        => 'fas fa-shield-alt',
  'description' => esc_html__('Export or import to use same settings in different websites.', 'chat-skype'),
  'fields'      => array(
    array(
      'type' => 'backup',
    ),
